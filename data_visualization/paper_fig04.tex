...
% Description: Temporal gap recovery. When a vessel disappears for 1--2 frames (frames 4--5), the gap recovery module uses motion prediction to recover weak detections and maintain track continuity.
