...
% Description: ST-DBSCAN neighborhood in $(x, t)$ space. The elliptical region defines spatial ($\varepsilon_s$) and temporal ($\varepsilon_t$) reachability. Coherent vessel points form dense clusters while isolated clutter is classified as noise.
