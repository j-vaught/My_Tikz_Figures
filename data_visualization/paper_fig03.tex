% Source: Code/PointCloudWork/docs/paper.tex
% Description: Identity tubes in spatio-temporal space. Each vessel forms a coherent ``tube'' through $(x, y, t)$ space as ST-DBSCAN links detections across frames. Isolated clutter points (gray) lack temporal continuity and are rejected as noise.
